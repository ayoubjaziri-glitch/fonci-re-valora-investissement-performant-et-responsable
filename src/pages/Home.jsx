        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-32">
          <motion.div
            ...
            <div className="mb-10 max-w-2xl space-y-5">
              <p className="text-sm text-white/50 uppercase tracking-[0.2em] font-medium border-l-2 border-[#C9A961] pl-4">Depuis 2008, le Groupe Auvergne et Patrimoine développe une expertise dans l'acquisition et la valorisation d'actifs résidentiels.
