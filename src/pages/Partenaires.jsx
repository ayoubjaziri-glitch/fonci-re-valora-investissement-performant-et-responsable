...
const valeurs = [
  { icon: Shield, titre: 'Confiance', desc: "Chaque partenaire est sélectionné sur la base de critères stricts de professionnalisme et d'intégrité." },
  { icon: TrendingUp, titre: 'Performance', desc: "Nous collaborons avec des acteurs dont l'excellence opérationnelle est reconnue sur leurs marchés." },
  { icon: Users, titre: 'Engagement', desc: "Nos relations partenariales s'inscrivent dans la durée, pour une création de valeur partagée et durable." },
  { icon: Building2, titre: 'Complémentarité', desc: "Un écosystème couvrant l'intégralité du cycle immobilier, de l'acquisition à la valorisation locative." },
];
...
export default function Partenaires() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-serif text-white mb-6">Écosystème de partenaires</h1>
      ...
      {/* Grille partenaires métiers — 1ère section */}
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">Des acteurs qualifiés intervenant sur l'ensemble du cycle de valorisation.</p>
          </motion.div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-xl mx-auto">Les principes qui guident chaque relation partenariale que nous nouons.</p>
          </motion.div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-2xl mx-auto">Chaque partenaire intègre notre réseau après un processus rigoureux garant de la qualité de nos opérations.</p>
          </motion.div>
          <div className="grid md:grid-cols-4 gap-6">
            {etapes.map((e, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
      ...
      {/* DynamicSections */}
      <DynamicSections page="ecosysteme" orderRange={[0, 99]} />
