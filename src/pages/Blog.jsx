...
Le premier critère de la Foncière Valora est la résilience de la demande. Investir dans une zone où la vacance locative est supérieure à la moyenne nationale (8,47 %) est un risque que la Foncière Valora refuse de prendre.
...
En 2026, la valeur d'un immeuble est dictée par son Diagnostic de Performance Énergétique (DPE). La Foncière Valora a fait de la "passoire thermique" son terrain de chasse privilégié.

- **La Décote à l'Achat :** La Foncière Valora cible des immeubles classés E, F ou G, permettant de négocier des prix d'acquisition avec une décote de −10 % à −15 % par rapport au prix du marché "vert".
- **La Transformation BBC :** L'objectif systématique de la Foncière Valora est de porter ces actifs au niveau DPE A ou B. Cette rénovation globale sécurise une plus-value latente immédiate de +10 % à +15 % et garantit la conformité aux interdictions de louer de 2028 et 2034.

## 3. L'Ingénierie Financière et l'Effet de Levier

La Foncière Valora ne se contente pas d'acheter des murs ; elle structure des opérations financières optimisées.

- **LTC Cible de 80 % :** La Foncière Valora maximise l'effet de levier bancaire en finançant jusqu'à 80 % du coût total de l'opération (acquisition + travaux). Avec des taux stabilisés autour de 3,25 % sur 20 ans, ce levier permet de viser un **TRI cible supérieur à 10 % net** pour les investisseurs.
- **Alignement d'Intérêts :** La Foncière Valora applique un rendement prioritaire (hurdle) de 6,5 %. La direction ne perçoit de rémunération sur la performance (carried interest) qu'une fois cet objectif atteint pour les associés.

## 4. Le Cadre Fiscal : Dispositif Jeanbrun et PEA-PME

Le choix du support d'investissement est aussi crucial que l'emplacement. La Foncière Valora utilise les leviers les plus puissants de la Loi de Finances 2026.

- **Le Dispositif Jeanbrun :** Ce nouveau "statut du bailleur privé" permet à la Foncière Valora d'amortir fiscalement 80 % de la valeur du bien, effaçant ainsi la quasi-totalité de l'imposition sur les revenus locatifs.
- **Éligibilité PEA-PME :** Les titres de la Foncière Valora sont éligibles au PEA-PME. Pour l'associé, cela signifie une **exonération totale d'impôt sur le revenu (12,8 %)** sur les gains et plus-values après 5 ans de détention.

## 5. Les Zones d'Intervention de la Foncière Valora en 2026

La Foncière Valora concentre son sourcing "Off-Market" sur quatre piliers géographiques stratégiques :

- **Bordeaux :** Pour sa solidité patrimoniale et l'impact du futur RER Métropolitain.
- **Lyon :** Pour sa tension locative extrême et les opportunités créées par la ZFE (Zone à Faibles Émissions).
- **Vichy :** Pour ses rendements bruts supérieurs à 9 % et son attractivité UNESCO.
- **Clermont-Ferrand :** Pour son bassin d'emploi industriel stable et ses prix d'entrée attractifs.

## Conclusion : Pourquoi choisir la Foncière Valora ?
...
La Foncière Valora souligne que la moyenne parisienne masque des écarts de prix extrêmes, créant des opportunités d'arbitrage uniques :
...
À Paris, la pression réglementaire est maximale. Depuis l'interdiction de louer les logements classés G au DPE, le parc immobilier parisien, majoritairement ancien, nécessite une intervention technique lourde.

La stratégie de la Foncière Valora repose sur la captation de ces actifs dégradés :
...
- **Super-Déficit Foncier :** Les travaux de rénovation énergétique pilotés par la Foncière Valora permettent d'optimiser fiscalement l'investissement via le déficit foncier renforcé à **21 400 € par an** jusqu'en 2027.

## 3. Dispositif Jeanbrun 2026 : L'atout fiscal à Paris

L'année 2026 consacre le dispositif Jeanbrun (Relance Logement) comme le nouvel outil de référence pour le résidentiel parisien. La Foncière Valora utilise ce mécanisme d'amortissement pour effacer l'imposition sur les revenus locatifs.
...
Rejoignez la Foncière Valora pour participer à la revalorisation durable du parc immobilier parisien.
...
- **Thermal-Vieux Vichy :** Le secteur le plus prestigieux où le prix des appartements rénovés atteint 2 378 €/m². La Foncière Valora y cible des micro-surfaces pour la location saisonnière et étudiante (filière masso-kinésithérapie).
- **Quartier Jeanne d'Arc - Stade :** Un secteur en pleine expansion, plébiscité par les familles et les jeunes actifs. La Foncière Valora identifie ici des immeubles de rapport offrant un prix attractif de 1 579 €/m².
...
Le parc immobilier de Vichy est riche en immeubles de caractère, mais beaucoup souffrent d'une obsolescence énergétique (DPE E, F ou G). La mission de la Foncière Valora consiste à acquérir ces actifs avec une décote de −10 % à −15 % pour les transformer en logements de **classe DPE A ou B**.

### L'expertise technique de la Foncière Valora

Grâce à son réseau de 30 entreprises BTP partenaires, la Foncière Valora déploie une ingénierie de rénovation BBC qui garantit :

- **Une "Valeur Verte" immédiate :** Une revalorisation du patrimoine de +10 % à +15 % dès la livraison des travaux.
- **Une attractivité locative record :** Avec des charges énergétiques divisées par trois, la Foncière Valora maintient un taux d'occupation cible supérieur à **98 %** sur ses actifs vichyssois.
- **Optimisation DPE :** La Foncière Valora tire profit du nouveau coefficient de conversion de l'électricité (passé à 1,9), permettant de sortir massivement les actifs du statut de passoire thermique.
...
Le modèle de la Foncière Valora repose sur un alignement total des intérêts : la direction ne perçoit de commission de performance (carried interest) qu'une fois que les associés ont récupéré leur capital majoré d'un rendement prioritaire de **6,5 % par an**.

## 4. Stratégie 2026 : Levier Jeanbrun et Agglomération "AGIR 2035"

La Foncière Valora s'appuie sur deux leviers de croissance majeurs pour sécuriser la performance à Vichy :

- **Le Dispositif Jeanbrun (Relance Logement) :** Ce nouveau statut du bailleur privé permet à la Foncière Valora de déduire un amortissement comptable (jusqu'à 12 000 €/an) de ses revenus locatifs. Contrairement au Pinel, il n'y a pas de zonage restrictif, ce qui est idéal pour les villes moyennes dynamiques comme Vichy.
- **Le Projet AGIR 2035 :** La feuille de route de Vichy Communauté prévoit 190 opérations de modernisation, incluant le réseau Vichy Campus et la redynamisation des centres-bourgs. La Foncière Valora anticipe une hausse continue de la demande pour les logements qualitatifs proches des pôles d'enseignement médical.

## 5. L'Équipe Valora : 18 ans d'ancrage territorial

La force de la Foncière Valora réside dans l'expérience de ses fondateurs, dont les racines sont profondément ancrées dans la région Auvergne :

- **Ayoub Jaziri :** Pilote la stratégie de financement optimisée à 80 % LTC (Loan-To-Cost).
- **Sophian Naili :** Expert du sourcing "Off-Market", il permet à la Foncière Valora d'accéder à des immeubles de rapport avant leur mise sur le marché public.
- **Renaud Marchand :** Ingénieur BTP, il supervise la qualité des rénovations BBC et la conformité aux normes environnementales de 2026.
...
Devenez associé de la Foncière Valora et participez à la revalorisation durable du patrimoine de Vichy. Le ticket d'entrée est fixé à **10 000 €** pour les premiers investisseurs.
